...
import { selectTotalItem } from "../../lib/store/cart";
import { selectProductSearch, updateFilter } from "../../lib/store/product";
import { selectCurrentUser, signOut } from "../../lib/store/user/user";
            ...
            <div className="col-lg-3 col-sm-6 col-8 order-2 order-lg-3">
              <div className="d-flex justify-content-end mb-3 mb-lg-0">
                <div className="widget-header">
                  <small className="title text-success" style={{fontSize: "15px"}}>
